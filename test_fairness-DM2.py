            ...
            for name in ['DM']:
                ...
                for fair_crt in ['FairDD']:
                    ...
                    for ipc in [10]:
                        ...
                        save_path = '/home/mmoslem3/scratch/FairDD/result/res_DM_CIFAR10_S_90_ConvNet_10ipc.pt'
                        save_path = '/home/mmoslem3/scratch/DREAM/results/CIFAR10_S_90/res_IDC_CIFAR10_S_90_ConvNet_10ipc.pt'
                        save_path = '/home/mmoslem3/scratch/FairDD/result_dream/data_499.pt'
                        save_path ='/home/mmoslem3/scratch/DREAM/results/CIFAR10_S_90/res_IDC_CIFAR10_S_90_ConvNet_10ipc.pt'
                        # save_path = '/home/mmoslem3/scratch/DREAM/results/CIFAR10_S_90/res_IDC_CIFAR10_S_90_ConvNet_10ipc.pt'
                        ...
                        try: 
                            try:
                                ...
                                checkpoint = torch.load(save_path.replace('15000', '20000'), map_location=args.device, weights_only=False)
